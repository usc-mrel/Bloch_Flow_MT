function [mx,my,mz] = bloch_flow_spoiling(b1, gr, taus, zetas, T1, T2, df, dp, mode, mx0, my0, mz0, F, lambda, m0, ASL_bolus)
% bloch_flow -- Bloch-Flow simulator with a perfect spoiler at the end of
%               interval (used for SPGR simulation)
%  Usage
...
%--------------------------------------------------------------------------
% If an SPGR signal is sought, spoiling of the magnetization needs to be
% considered before the rotation of the free pool.
%--------------------------------------------------------------------------
S = [0 0 0; 0 0 0; 0 0 1];                 
